...
impl Error {
    ...
    pub fn environment(msg: impl Into<String>) -> Self {
        Self::Custom(format!("Environment error: {}", msg.into()))
    }

    /// Create a config error
    pub fn config_error(msg: impl Into<String>) -> Self {
        Self::Custom(format!("Config error: {}", msg.into()))
    }
