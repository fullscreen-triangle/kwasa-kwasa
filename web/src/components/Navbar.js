  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/docs" title="Docs" />
        <CustomLink className="mx-4" href="/playground" title="Playground" />
        <CustomLink className="ml-4" href="/translator" title="Translator" />
      </nav>
      <nav
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/docs" title="Docs" />
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/playground" title="Playground" />
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/translator" title="Translator" />
      </nav>
      <nav
