...
Usage: python turbulance.py script.trb
"""
...
def main():
    """CLI entry point"""
    if len(sys.argv) < 2:
        print("Usage: python turbulance.py script.trb")
        print()
        print("Turbulance Compiler - Consciousness Programming Language")
        print()
        print("Examples:")
        print("  python turbulance.py examples/turbulance/01_oscillatory_state_as_point.trb")
        print("  python turbulance.py examples/turbulance/02_drug_efficacy_resolution.trb")
        sys.exit(1)
    ...
    try:
        compiler.execute_file(script_path)
