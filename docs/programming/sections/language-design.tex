...
\begin{verbatim}
given measurement > threshold:
    // Executes given P(measurement > threshold | data) > 0.95
\end{verbatim}
...
given measurement.value > threshold.value:
...
funxn treat_depression(patient: PatientData) -> TreatmentProtocol:
    ...
    given efficacy_result.conclusion > 0.95:
