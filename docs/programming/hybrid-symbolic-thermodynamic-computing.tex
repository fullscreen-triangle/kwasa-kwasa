...
\input{sections/prerequisites-for-computation}
\input{sections/oscillatory-computing}
\input{sections/symbolic-thermodynamics}

\input{sections/language-design}

\input{sections/four-file-architecture}

\input{sections/v8-intelligence-network}

\input{sections/thermodynamic-consequences}

\input{sections/clinical-validation}
